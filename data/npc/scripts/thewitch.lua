...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'sell') or msgcontains(msg, 'buy') or msgcontains(msg, 'comprar') or msgcontains(msg, 'vender') or msgcontains(msg, 'help') then
		selfSay('Morte aos zumbis! Me traga seus cerebros que te dou {premierball} ou {bag} em troca.', cid)
	elseif msgcontains(msg, 'premier') or msgcontains(msg, 'premierball') then
		selfSay('Quantos half-eaten brain deseja trocar por premierball?', cid)
		npcHandler.topic[cid] = 1
	elseif npcHandler.topic[cid] == 1 then
		numberPremier = tonumber(msg)
		if numberPremier and numberPremier > 0 then
			selfSay('Gostaria de trocar ' .. numberPremier .. ' half-eaten brain por ' .. numberPremier .. ' premierballs?', cid)
	...
	elseif npcHandler.topic[cid] == 2 and (msgcontains(msg, 'sim') or msgcontains(msg, 'yes')) then
		...
		if player:removeItem("half-eaten brain", numberPremier) then
			selfSay('Aqui estao suas premierballs. Volte sempre!', cid)
			player:addItem("empty premierball", numberPremier)
			npcHandler.topic[cid] = 0
			npcHandler:releaseFocus(cid)
		else
			selfSay('Voce nao possui o suficiente!', cid)
			npcHandler.topic[cid] = 0
			npcHandler:releaseFocus(cid)
		end
	...
	elseif msgcontains(msg, 'aerodactyl') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma aerodactyl bag?', cid)
		npcHandler.topic[cid] = 4
	elseif npcHandler.topic[cid] == 4 and (msgcontains(msg, 'sim') or msgcontains(msg, 'yes')) then
		local player = Player(cid)
		if player:removeItem("half-eaten brain", priceBags) then
	...
	elseif msgcontains(msg, 'charizard') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma charizard bag?', cid)
	...
	elseif msgcontains(msg, 'chikorita') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma chikorita bag?', cid)
	...
	elseif msgcontains(msg, 'dragonite') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma dragonite bag?', cid)
	...
	elseif msgcontains(msg, 'eevee') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma eevee bag?', cid)
	...
	elseif msgcontains(msg, 'espeon') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma espeon bag?', cid)
	...
	elseif msgcontains(msg, 'flareon') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma flareon bag?', cid)
	...
	elseif msgcontains(msg, 'golduck') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma golduck bag?', cid)
	...
	elseif msgcontains(msg, 'haunter') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma haunter bag?', cid)
	...
	elseif msgcontains(msg, 'jolteon') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma jolteon bag?', cid)
	...
	elseif msgcontains(msg, 'jynx') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma jynx bag?', cid)
	...
	elseif msgcontains(msg, 'machamp') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma machamp bag?', cid)
	...
	elseif msgcontains(msg, 'marowak') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma marowak bag?', cid)
	...
	elseif msgcontains(msg, 'mr. mime') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma mr. mime bag?', cid)
	...
	elseif msgcontains(msg, 'pidgeot') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma pidgeot bag?', cid)
	...
	elseif msgcontains(msg, 'pikachu') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma pikachu bag?', cid)
	...
	elseif msgcontains(msg, 'sandslash') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma sandslash bag?', cid)
	...
	elseif msgcontains(msg, 'scyther') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma scyther bag?', cid)
	...
	elseif msgcontains(msg, 'scizor') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma scizor bag?', cid)
	...
	elseif msgcontains(msg, 'sneasel') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma sneasel bag?', cid)
	...
	elseif msgcontains(msg, 'snorlax') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma snorlax bag?', cid)
	...
	elseif msgcontains(msg, 'umbreon') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma umbreon bag?', cid)
	...
	elseif msgcontains(msg, 'vaporeon') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma vaporeon bag?', cid)
	...
	elseif msgcontains(msg, 'victrebeel') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma victrebeel bag?', cid)
	...
	elseif msgcontains(msg, 'wartortle') then
		selfSay('Deseja trocar ' .. priceBags .. ' half-eaten brain por uma wartortle bag?', cid)
